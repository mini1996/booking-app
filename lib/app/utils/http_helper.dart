...
import 'package:bookingapp/app/utils/db_helper.dart';
        ...
        try {
          ...
          switch (requestType) {
            ...
            case HttpMethods.put:
              response = await http.put(endPointURL, body: data, headers: {
                "Content-Type": "application/json",
                "Authorization":
                    authenticationRequired ? "Bearer $authToken" : ""
              }).timeout(Settings.httpRequestTimeout);
              break;
            case HttpMethods.delete:
              response = await http.delete(endPointURL, headers: {
                "Content-Type": "application/json",
                "Authorization":
                    authenticationRequired ? "Bearer $authToken" : ""
              }).timeout(Settings.httpRequestTimeout);
